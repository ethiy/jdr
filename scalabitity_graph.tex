...
\begin{document}
	...
	\begin{tikzpicture}
        ...
        \path[edge, darkgreen] (z1) to node[midway, sloped, above, align=center]{Transferability} (z2.west);
        \path[edge, darkgreen] (z1) to node[midway, sloped, above, align=center]{Transferability} (z3.200);
