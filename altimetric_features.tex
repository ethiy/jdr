...
\begin{document}
	\begin{tikzpicture}
		\node (dsm) at (0,0) {\includegraphics[height=3cm]{images/height_features/dsm-292034}};
        \path (dsm.south) + (0,-1.5) node[black] (dsm_2) {\includegraphics[height=3cm]{images/height_features/dsm-61215}};
        \path (dsm_2.south) + (0,-.25) node (dsm_legend) {(a) DSM};
        \path (dsm.east) + (2,0) node (simulated) {\includegraphics[height=3cm]{images/height_features/heightmap-292034}};
        \path (simulated.south) + (0,-1.5) node (simulated_2) {\includegraphics[height=3cm]{images/height_features/heightmap-61215}};
        \path (simulated_2.south) + (0,-.25) node (sim_legend) {(b) Model heightmap};
        \path (simulated.east) + (2,0) node (residual) {\includegraphics[height=3cm]{images/height_features/residual-292034}};
        \path (residual.south) + (0,-1.5) node (residual_2) {\includegraphics[height=3cm]{images/height_features/residual-61215}};
