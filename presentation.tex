...
\begin{document}
    ...
    \section{Experiments}
        ...
        \begin{frame}{Feature importance}
            ...
            \only<4->{
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}, itemsep=2em]
                    \item<4-> All features importances hover \underline{equally} around 33\%.
        ...
        \begin{frame}{Generalization}
            ...
            \only<2->{
                ...
                \end{table}
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                    \item<2-> \footnotesize \footnotesize Only 3/12 of \texttt{Building errors} generalization cases are \textcolor{IGNGreen}{positive}.
        ...
        \begin{frame}{Representativeness}
            ...
            \end{figure}
            \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                \item<2-> F-scores are \textbf{stable} no matter how much the \underline{training set size} changes.
                \item<3-> Results are even \underline{more stable} for the \underline{very frequent} errors.
            \end{itemize}
        \end{frame}
