...
\begin{document}
    \begin{tikzpicture}
        ...
        \path[draw, ->, line width=1pt, rounded corners=10pt, IGNGreen] (residual |- features_down.south) -- (errors.north) node [midway, left, IGNGreen] {\scriptsize Classifier (RF, SVM \dots)};
    \end{tikzpicture}
\end{document}
