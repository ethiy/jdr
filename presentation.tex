                    ...
                    \begin{figure}
                        \begin{center}
                            \begin{subfigure}{.33\textwidth}
                                \centering
                                \fbox{\includegraphics[height=.5\textwidth]{images/errors/facet/under_segmentation}}
                                \caption{\label{fig::fac_under} Under segmentation}
                            \end{subfigure}
                            \begin{subfigure}{.33\textwidth}
                                \centering
                                \fbox{\includegraphics[height=.5\textwidth]{images/errors/facet/over_segmentation}}
                                \caption{\label{fig::fac_over} Over segmentation}
                            \end{subfigure}
                            \begin{subfigure}{.33\textwidth}
                                \centering
                                \fbox{\includegraphics[height=.5\textwidth]{images/errors/facet/geometry}}
                ...
                \only<2>{
                    \begin{figure}
                        \begin{center}
                            \begin{subfigure}{.45\textwidth}
                                \centering
                                \fbox{\includegraphics[height=.5\textwidth]{images/errors/facet/border}}
                                \caption{\label{fig::fac_footprint} Imprecise borders}
                            \end{subfigure}
                            \begin{subfigure}{.45\textwidth}
                                \centering
                                \fbox{\includegraphics[height=.5\textwidth]{images/errors/facet/topology}}
