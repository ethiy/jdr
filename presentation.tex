...
\date{\tiny \today} % \DTMdisplaydate{2019}{4}{19}{5}
...
\begin{document}
        ...
        \begin{frame}{Motivation}
            \only<1-4|handout:1>{
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}, itemsep=2em]
                    \item<1-> Automatic urban modeling: an \underline{active} research area \cite{Musialski2012};
                    \item<2-> Results \textcolor{IGNGreen}{seamless} but \textcolor{IGNRed}{lack generality} and \textcolor{IGNRed}{often erroneous} \cite{rottensteiner2014results};
                    \begin{itemize}[label=$\longrightarrow$]
                        \item<3-> labourious manual corrections: $\approx$ \SI{2}{\hour\per\km\squared} per expert.
                    \end{itemize}
                    \item<4-> Urban 3D model semantic diagnostic \textcolor{IGNRed}{not well studied} \cite{boudet2006supervised, Michelin2013};
                \end{itemize}
            }
            \only<5-|handout:2>{
    ...
    \section{Experiments}
        ...
        \begin{frame}{Scalability study: conducted experimentations}
            ...
            \only<1|handout:0>{
                \begin{itemize}
                    \item[] \phantom{\footnotesize Transferability: train on \underline{one} scene and test on a different \underline{one}}.
                \end{itemize}
            }
            \only<2|handout:0>{
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                ...
                \begin{table}
                    ...
                    \begin{center}
                        \begin{tabular}{| x{1.5cm}| x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} |}
                            ...
                            \hline
                            Nantes $\rightarrow$ Paris-13  & \cellcolor{Moins1}& \cellcolor{Moins2}& \cellcolor{IGNDarkGrey} & \cellcolor{Plus2}& \cellcolor{Zero}& \cellcolor{Plus1}& \cellcolor{Plus1}& \cellcolor{IGNDarkGrey} &\cellcolor{Zero}\\
                            \hline
                            ...
                            \hline
                            Paris-13 $\rightarrow$ Nantes  &\cellcolor{Moins2} & \cellcolor{Moins1}& \cellcolor{IGNDarkGrey} & \cellcolor{Plus1}&\cellcolor{Zero} & \cellcolor{Moins3}& \cellcolor{Zero}& \cellcolor{IGNDarkGrey} & \cellcolor{Moins1} Hei.\\
                            \hline
                            Paris-13 $\rightarrow$ Elancourt &\cellcolor{Zero} &\cellcolor{Moins1} & \cellcolor{Plus1}Im. & \cellcolor{Zero}& \cellcolor{Zero}& \cellcolor{Moins4}& \cellcolor{Moins2}Im. & \cellcolor{IGNDarkGrey} & \cellcolor{Zero}\\
                            \hline
                        \end{tabular}
                    \end{center}
                    \caption{\scriptsize Fxy $\rightarrow$ Facet <x> <y>. Bxy $\rightarrow$ Building <x> <y>. XOS $\rightarrow$ <X> oversegmentation. XUS $\rightarrow$ <X> undersegmentation. XIT $\rightarrow$ <X> inaccurate topology. XIB $\rightarrow$ <X> imprecise border. XIG $\rightarrow$ <X> imprecise geometry.}
                \end{table}
                \begin{center}
                    \begin{tikzpicture}
                        ...
                        \draw[black, fill=IGNDarkGrey] (5, -.75) rectangle (4, -1);
                ...
                \begin{table}
                    ...
                    \begin{center}
                        \begin{tabular}{| x{1.5cm}| x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} |}
                            ...
                            \hline
                            El. $\cup$ P-13 $\rightarrow$ Nantes & \cellcolor{Zero}All& \cellcolor{Moins2}Im.&\cellcolor{Moins1}Im. &\cellcolor{Plus2} &\cellcolor{Zero} & \cellcolor{Zero}& \cellcolor{Moins2}Im.& \cellcolor{IGNDarkGrey} &\cellcolor{Zero}\\
                            \hline
                            El. $\cup$ Nnt. $\rightarrow$ Paris-13 &\cellcolor{Moins2}All &\cellcolor{Moins2} & \cellcolor{IGNDarkGrey} &\cellcolor{Plus1}Hei. &\cellcolor{Zero} &\cellcolor{Moins4} &\cellcolor{Moins2}Im. & \cellcolor{IGNDarkGrey} &\cellcolor{Moins1}\\
                            \hline
                        \end{tabular}
                    \end{center}
                \end{table}
                ...
                \begin{table}
                    ...
                    \begin{center}
                        \begin{tabular}{| x{1.5cm}| x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} | x{.4cm} |}
                            ...
                            \hline
                            El. $\cup$ P-13 $\rightarrow$ Nantes   & \cellcolor{IGNGreen}All& \cellcolor{IGNRed}Im.&\cellcolor{IGNRed}Im. &\cellcolor{IGNGreen} &\cellcolor{IGNGreen} & \cellcolor{IGNGreen}& \cellcolor{IGNRed}Im.& \cellcolor{IGNDarkGrey} &\cellcolor{IGNGreen}\\
                            \hline
                            El. $\cup$ Nnt. $\rightarrow$ Paris-13   &\cellcolor{IGNRed}All &\cellcolor{IGNRed} & \cellcolor{IGNDarkGrey} &\cellcolor{IGNGreen}Hei. &\cellcolor{IGNGreen} &\cellcolor{IGNRed} &\cellcolor{IGNRed}Im. & \cellcolor{IGNDarkGrey} &\cellcolor{IGNRed}\\
                            \hline
                        \end{tabular}
                        \caption{\footnotesize \textcolor{IGNRed}{$\blacksquare$}: Loss in F-score, \textcolor{IGNGreen}{$\blacksquare$}: Stability or gain in F-score.}
                    \end{center}
