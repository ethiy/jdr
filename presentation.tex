...
\begin{document}
        ...
        \begin{frame}{Motivation}
            \only<1-4>{
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}, itemsep=2em]
                    ...
                    \end{itemize}
                    \item<4-> Urban 3D model semantic diagnostic \textcolor{purple}{not well studied} \citep{boudet2006supervised, Michelin2013};
                \end{itemize}
            }
            \only<5->{
                \begin{block}{\textcolor{purple}{Goal}}
                    Detect and describe semantic errors that affect building 3D models.
                \end{block}
                ~\\
                \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}, itemsep=2em]
                ...
                \begin{columns}[T]
                    \begin{column}{0.5\textwidth}
                        \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}, itemsep=2em]
                            ...
                            \item<6-> Urban models correction;
                            \item<7-> Urban reconstruction method evaluation;
                            \item<8-> Crowd reconstruction quality assessment.
                        \end{itemize}
                    \end{column}
                    \begin{column}{0.45\textwidth}
                        \only<1>{
                            \begin{figure}
                                \begin{center}
                                    \includegraphics[width=\textwidth]{images/recal69/mns-shade-masq_0}
                                \end{center}
                            \end{figure}
                        }
                        \only<2>{
                            \begin{figure}
                                \begin{center}
                                    \includegraphics[width=\textwidth]{images/recal69/mns-shade-masq_1}
                                \end{center}
                            \end{figure}
                        }
                        \only<3>{
                            \begin{figure}
                                \begin{center}
                                    \includegraphics[width=\textwidth]{images/recal69/mns-shade-masq_2}
                                \end{center}
                            \end{figure}
                        }
                        \only<4>{
                            \begin{figure}
                                \begin{center}
                                    \includegraphics[width=\textwidth]{images/recal69/mns-shade-masq_3}
                                \end{center}
                            \end{figure}
                        }
                        \only<5>{
                            \begin{figure}
                                \begin{center}
                                    \includegraphics[width=\textwidth]{images/recal69/mns-shade-masq_4}
                                \end{center}
                            \end{figure}
                        }
                        \only<6>{
    ...
    \section{Experiments}
        ...
        \begin{frame}{Ablation study: Elancourt example}
            ...
            \only<1>{
                \begin{center}
                    \footnotesize Results in percentage.
                \end{center}
            }
            \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
        ...
        \begin{frame}{Transferability and Generalization}
            \begin{table}
                ...
                \begin{center}
                    \begin{tabular}{c c| x{.4cm} x{.4cm} x{.4cm} x{.4cm} |x{.4cm} x{.4cm} x{.4cm} x{.55cm} x{.4cm}}
                        ...
                        &Paris-13   &\cellcolor{Moins2}All &\cellcolor{Moins2} & \cellcolor{black} &\cellcolor{Plus1}Hei. &\cellcolor{Zero} &\cellcolor{Moins4} &\cellcolor{Moins2}Im. & &\cellcolor{Moins1}\\
                        \hline
                    \end{tabular}
                \end{center}
            \end{table}
            ...
            \begin{itemize}[label=$\blacktriangleright$, font=\color{IGNGreen}]
                ...
                \item<4-> \footnotesize Generalization experiments confirm that more diverse training data result in better results.
            \end{itemize}
        \end{frame}
        ...
        \begin{frame}{\textcolor{yellow}{Conclusion} \& \textcolor{purple}{Perspectives}}
            ...
            \uncover<6->{
                ...
                \begin{itemize}[label=$\blacktriangleright$, font=\color{purple}, itemsep=2em]
                    \item<6-> Dataset augmentation $\longrightarrow$ \textbf{Simulate errors};
                    \item<7-> Extend to richer features $\longrightarrow$ Graph kernels, Scattering.
                \end{itemize}
            }
        \end{frame}
\end{document}
