...
\begin{document}
    \begin{tikzpicture}
        ...
        \draw[decorate, decoration={brace, amplitude=3pt, aspect=.491}] (facet_graph.north west) -- (ortho_projection_legend.east |- facet_graph.north) node (features_up) {};
        \draw[decorate, decoration={brace, amplitude=3pt, mirror, aspect=.491}] (facet_graph_legend.south west) -- (ortho_projection_legend.east |- facet_graph_legend.south west) node (features_down) {};
        ...
        \path[draw, ->, line width=1pt, rounded corners=10pt, IGNGreen] (model_legend.south) -- (residual |- features_up.north);
        \path[draw, ->, line width=1pt, rounded corners=10pt, IGNGreen] (residual |- features_down.south) -- (errors.north) node [midway, left, IGNGreen] {\scriptsize Classifier (\underline{RF}, SVM \dots)};
    \end{tikzpicture}
\end{document}
