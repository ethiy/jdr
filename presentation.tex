    ...
    \section{Experiments}
        \begin{frame}{Datasets}
            ...
            \only<4>{
                \begin{figure}
                    \begin{center}
                        \includestandalone[mode=buildmissing, height=.7\textheight]{dataset_stats_finesse_2}
                    \end{center}
                \end{figure}
            }
            \only<5>{
                \begin{figure}
                    \begin{center}
                        \includestandalone[mode=buildmissing, height=.45\textheight]{dataset_stats_finesse_3}
                    \end{center}
                \end{figure}
            }
        \end{frame}
